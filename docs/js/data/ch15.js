const ch15 = {
  ...
  <text x="155" y="224" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="11" font-weight="700">x = 0</text>
    ...
    },
    {
      ...
      type: "mcq",
      question: "What is the midpoint of the line segment joining <strong>A(2, 4)</strong> and <strong>B(6, 4)</strong>?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 160" aria-label="Number line showing midpoint of segment from (2,4) to (6,4)">
  <rect width="340" height="160" fill="#f8fafc" rx="8"/>
  <!-- horizontal line segment -->
  <line x1="60" y1="80" x2="280" y2="80" stroke="#5b5ef4" stroke-width="3"/>
  <!-- point A at x=2 (60px) -->
  <circle cx="60" cy="80" r="7" fill="#5b5ef4"/>
  <text x="60" y="68" text-anchor="middle" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">A(2, 4)</text>
  <!-- point B at x=6 (280px) -->
  <circle cx="280" cy="80" r="7" fill="#5b5ef4"/>
  <text x="280" y="68" text-anchor="middle" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">B(6, 4)</text>
  <!-- midpoint at x=4 (170px) -->
  <circle cx="170" cy="80" r="7" fill="#f43f5e"/>
  <text x="170" y="68" text-anchor="middle" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">M = ?</text>
  <!-- brace indicators -->
  <line x1="60" y1="100" x2="170" y2="100" stroke="#64748b" stroke-width="1.5"/>
  <line x1="170" y1="100" x2="280" y2="100" stroke="#64748b" stroke-width="1.5"/>
  <text x="115" y="116" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2 units</text>
  <text x="225" y="116" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2 units</text>
  <text x="170" y="145" text-anchor="middle" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">M = ((2+6)/2, (4+4)/2) = (4, 4)</text>
</svg>`,
      options: ["(3, 4)", "(4, 4)", "(4, 8)", "(8, 8)"],
      answer: 1,
      explanation: "The midpoint formula is M = ((x₁+x₂)/2, (y₁+y₂)/2). Here: x = (2+6)/2 = 4 and y = (4+4)/2 = 4. So the midpoint is (4, 4). Because both points have the same y-value, the midpoint is simply halfway along the x-values."
    },
    {
      id: "c15_q22",
      topic: "Midpoint of a line segment",
      type: "input",
      question: "Find the midpoint of the line segment joining <strong>P(1, 3)</strong> and <strong>Q(5, 7)</strong>. Write your answer as (x, y).",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340" aria-label="Grid showing segment PQ from (1,3) to (5,7) with midpoint">
  <rect width="340" height="340" fill="#f8fafc" rx="8"/>
  <!-- grid lines: origin bottom-left at (40,300), 40px/unit -->
  <line x1="40" y1="300" x2="320" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="260" x2="320" y2="260" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="220" x2="320" y2="220" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="180" x2="320" y2="180" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="140" x2="320" y2="140" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="100" x2="320" y2="100" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="60" x2="320" y2="60" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="20" x2="320" y2="20" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="40" y1="20" x2="40" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="80" y1="20" x2="80" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="120" y1="20" x2="120" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="160" y1="20" x2="160" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="200" y1="20" x2="200" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="240" y1="20" x2="240" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="280" y1="20" x2="280" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="320" y1="20" x2="320" y2="310" stroke="#e2e8f0" stroke-width="1"/>
  <!-- axes -->
  <line x1="40" y1="300" x2="325" y2="300" stroke="#64748b" stroke-width="2"/>
  <line x1="40" y1="300" x2="40" y2="15" stroke="#64748b" stroke-width="2"/>
  <polygon points="325,300 317,295 317,305" fill="#64748b"/>
  <polygon points="40,15 35,23 45,23" fill="#64748b"/>
  <text x="328" y="304" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">x</text>
  <text x="43" y="13" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">y</text>
  <!-- axis labels: x=40+n*40, y=300-n*40 -->
  <text x="40" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">0</text>
  <text x="80" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">1</text>
  <text x="120" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2</text>
  <text x="160" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">3</text>
  <text x="200" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">4</text>
  <text x="240" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">5</text>
  <text x="280" y="315" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">6</text>
  <text x="32" y="304" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">0</text>
  <text x="32" y="264" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">1</text>
  <text x="32" y="224" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2</text>
  <text x="32" y="184" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">3</text>
  <text x="32" y="144" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">4</text>
  <text x="32" y="104" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">5</text>
  <text x="32" y="64" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">6</text>
  <text x="32" y="24" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">7</text>
  <!-- P(1,3): x=40+1*40=80, y=300-3*40=180 -->
  <!-- Q(5,7): x=40+5*40=240, y=300-7*40=20 -->
  <!-- M(3,5): x=40+3*40=160, y=300-5*40=100 -->
  <line x1="80" y1="180" x2="240" y2="20" stroke="#5b5ef4" stroke-width="2.5"/>
  <circle cx="80" cy="180" r="6" fill="#5b5ef4"/>
  <text x="65" y="175" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">P(1,3)</text>
  <circle cx="240" cy="20" r="6" fill="#5b5ef4"/>
  <text x="245" y="18" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">Q(5,7)</text>
  <circle cx="160" cy="100" r="7" fill="#f43f5e"/>
  <text x="168" y="97" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">M = ?</text>
</svg>`,
      answer: "(3, 5)",
      acceptableAnswers: ["(3, 5)", "3, 5", "3,5"],
      explanation: "Use the midpoint formula: M = ((x₁+x₂)/2, (y₁+y₂)/2). Here x = (1+5)/2 = 6/2 = 3, and y = (3+7)/2 = 10/2 = 5. So the midpoint M is (3, 5)."
    },
    {
      id: "c15_q23",
      topic: "Midpoint of a line segment",
      type: "mcq",
      question: "The midpoint of a line segment is <strong>M(4, 1)</strong>. One endpoint is <strong>A(1, 3)</strong>. What are the coordinates of the other endpoint <strong>B</strong>?",
      options: ["(7, −1)", "(5, 2)", "(3, 4)", "(8, 2)"],
      answer: 0,
      explanation: "If M is the midpoint of AB, then: Mx = (Ax + Bx)/2, so 4 = (1 + Bx)/2, which gives Bx = 8 − 1 = 7. Similarly: My = (Ay + By)/2, so 1 = (3 + By)/2, which gives By = 2 − 3 = −1. So B = (7, −1).",
    ...
    },
    {
      ...
      type: "mcq",
      question: "Points <strong>A(1, 3)</strong> and <strong>B(7, 3)</strong> are on the same horizontal line. What is the distance between them?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 80" aria-label="Number line showing distance from x=1 to x=7">
  <rect width="380" height="80" fill="#f8fafc" rx="8"/>
  <!-- number line -->
  <line x1="20" y1="40" x2="360" y2="40" stroke="#64748b" stroke-width="2"/>
  <!-- ticks: x=20+n*45 for n=0..7 -->
  <line x1="20" y1="35" x2="20" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="20" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">0</text>
  <line x1="65" y1="35" x2="65" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="65" y="60" text-anchor="middle" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">1</text>
  <line x1="110" y1="35" x2="110" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="110" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2</text>
  <line x1="155" y1="35" x2="155" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="155" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">3</text>
  <line x1="200" y1="35" x2="200" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="200" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">4</text>
  <line x1="245" y1="35" x2="245" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="245" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">5</text>
  <line x1="290" y1="35" x2="290" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="290" y="60" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">6</text>
  <line x1="335" y1="35" x2="335" y2="45" stroke="#64748b" stroke-width="1.5"/>
  <text x="335" y="60" text-anchor="middle" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">7</text>
  <!-- segment from x=1 to x=7 -->
  <line x1="65" y1="40" x2="335" y2="40" stroke="#f43f5e" stroke-width="3"/>
  <circle cx="65" cy="40" r="6" fill="#5b5ef4"/>
  <text x="65" y="25" text-anchor="middle" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">A</text>
  <circle cx="335" cy="40" r="6" fill="#5b5ef4"/>
  <text x="335" y="25" text-anchor="middle" fill="#5b5ef4" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">B</text>
  <text x="200" y="25" text-anchor="middle" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">distance = 7 − 1 = 6</text>
</svg>`,
      options: ["5 units", "6 units", "7 units", "8 units"],
      answer: 1,
      explanation: "When two points share the same y-coordinate, the distance is simply the difference in x-values. Distance = 7 − 1 = 6 units."
    },
    {
      id: "c15_q25",
      topic: "Distance between two points",
      type: "input",
      question: "Points <strong>C(3, −2)</strong> and <strong>D(3, 5)</strong> share the same x-coordinate. What is the distance between them? Write just the number of units.",
      answer: "7",
      acceptableAnswers: ["7", "7 units"],
      explanation: "When two points share the same x-coordinate, the distance is the difference in y-values: 5 − (−2) = 5 + 2 = 7 units. Because one y-value is negative, remember to add when subtracting a negative number."
    },
    {
      id: "c15_q26",
      topic: "Distance between two points",
      type: "mcq",
      question: "A rectangle has corners at <strong>(1, 2)</strong>, <strong>(5, 2)</strong>, <strong>(5, 6)</strong> and <strong>(1, 6)</strong>. What is the <strong>perimeter</strong> of this rectangle?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 320" aria-label="Rectangle on coordinate grid with corners at (1,2), (5,2), (5,6), (1,6)">
  <rect width="320" height="320" fill="#f8fafc" rx="8"/>
  <!-- grid: origin at (30,290), 40px/unit -->
  <line x1="30" y1="290" x2="310" y2="290" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="250" x2="310" y2="250" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="210" x2="310" y2="210" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="170" x2="310" y2="170" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="130" x2="310" y2="130" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="90" x2="310" y2="90" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="50" x2="310" y2="50" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="30" y1="20" x2="30" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="70" y1="20" x2="70" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="110" y1="20" x2="110" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="150" y1="20" x2="150" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="190" y1="20" x2="190" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="230" y1="20" x2="230" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="270" y1="20" x2="270" y2="300" stroke="#e2e8f0" stroke-width="1"/>
  <!-- axes -->
  <line x1="30" y1="290" x2="310" y2="290" stroke="#64748b" stroke-width="2"/>
  <line x1="30" y1="290" x2="30" y2="20" stroke="#64748b" stroke-width="2"/>
  <!-- axis numbers: x=30+n*40, y=290-n*40 -->
  <text x="70" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">1</text>
  <text x="110" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2</text>
  <text x="150" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">3</text>
  <text x="190" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">4</text>
  <text x="230" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">5</text>
  <text x="270" y="305" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">6</text>
  <text x="22" y="294" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">0</text>
  <text x="22" y="254" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">1</text>
  <text x="22" y="214" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">2</text>
  <text x="22" y="174" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">3</text>
  <text x="22" y="134" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">4</text>
  <text x="22" y="94" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">5</text>
  <text x="22" y="54" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">6</text>
  <!-- rectangle: (1,2)=(70,210), (5,2)=(230,210), (5,6)=(230,50), (1,6)=(70,50) -->
  <rect x="70" y="50" width="160" height="160" fill="rgba(91,94,244,0.12)" stroke="#5b5ef4" stroke-width="2.5"/>
  <!-- corner dots -->
  <circle cx="70" cy="210" r="5" fill="#5b5ef4"/>
  <text x="55" y="225" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="11">(1,2)</text>
  <circle cx="230" cy="210" r="5" fill="#5b5ef4"/>
  <text x="233" y="225" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="11">(5,2)</text>
  <circle cx="230" cy="50" r="5" fill="#5b5ef4"/>
  <text x="233" y="47" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="11">(5,6)</text>
  <circle cx="70" cy="50" r="5" fill="#5b5ef4"/>
  <text x="15" y="47" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="11">(1,6)</text>
  <!-- dimension labels -->
  <text x="150" y="230" text-anchor="middle" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">width = 4</text>
  <text x="258" y="130" text-anchor="start" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">height = 4</text>
</svg>`,
      options: ["8 units", "16 units", "12 units", "20 units"],
      answer: 1,
      explanation: "First find the side lengths using differences in coordinates. Width = 5 − 1 = 4 units. Height = 6 − 2 = 4 units. Perimeter = 2 × (4 + 4) = 2 × 8 = 16 units."
    },
    {
      id: "c15_q27",
      topic: "Reflection of a point",
      type: "mcq",
      question: "Point A is at <strong>(3, 5)</strong>. It is reflected in the <strong>x-axis</strong>. What are the new coordinates?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" aria-label="Coordinate grid showing reflection of (3,5) in x-axis to (3,-5)">
  <rect width="300" height="300" fill="#f8fafc" rx="8"/>
  <!-- grid: center (150,150), 25px/unit -->
  <line x1="25" y1="25" x2="25" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="50" y1="25" x2="50" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="75" y1="25" x2="75" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="100" y1="25" x2="100" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="125" y1="25" x2="125" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="175" y1="25" x2="175" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="200" y1="25" x2="200" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="225" y1="25" x2="225" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="250" y1="25" x2="250" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="275" y1="25" x2="275" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="25" x2="275" y2="25" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="50" x2="275" y2="50" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="75" x2="275" y2="75" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="100" x2="275" y2="100" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="125" x2="275" y2="125" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="175" x2="275" y2="175" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="200" x2="275" y2="200" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="225" x2="275" y2="225" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="250" x2="275" y2="250" stroke="#e2e8f0" stroke-width="1"/>
  <line x1="25" y1="275" x2="275" y2="275" stroke="#e2e8f0" stroke-width="1"/>
  <!-- x-axis mirror line highlighted -->
  <line x1="20" y1="150" x2="285" y2="150" stroke="#22c55e" stroke-width="2.5" stroke-dasharray="7,3"/>
  <!-- axes -->
  ...
  <!-- axis numbers: 25px/unit from center 150 -->
  <text x="175" y="163" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">1</text>
  <text x="200" y="163" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">2</text>
  <text x="225" y="163" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">3</text>
  <text x="142" y="125" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">1</text>
  <text x="142" y="100" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">2</text>
  <text x="142" y="75" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">3</text>
  <text x="142" y="50" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">4</text>
  <text x="142" y="25" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">5</text>
  <text x="142" y="175" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">-1</text>
  <text x="142" y="200" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">-2</text>
  <text x="142" y="225" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">-3</text>
  <text x="142" y="250" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">-4</text>
  <text x="142" y="275" text-anchor="end" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="10">-5</text>
  <!-- A(3,5): x=150+3*25=225, y=150-5*25=25 -->
  <!-- A'(3,-5): x=225, y=150+5*25=275 -->
  <!-- dashed vertical line connecting A to A' -->
  <line x1="225" y1="25" x2="225" y2="275" stroke="#64748b" stroke-width="1" stroke-dasharray="4,3"/>
  <circle cx="225" cy="25" r="7" fill="#5b5ef4"/>
  <text x="232" y="22" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">A(3, 5)</text>
  <circle cx="225" cy="275" r="7" fill="#f43f5e"/>
  <text x="232" y="278" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">A'(3, −5)</text>
  <!-- x-axis mirror label -->
  <text x="30" y="144" fill="#22c55e" font-family="Nunito,Arial,sans-serif" font-size="11" font-weight="700">x-axis (mirror)</text>
</svg>`,
      options: ["(−3, 5)", "(3, −5)", "(−3, −5)", "(5, 3)"],
      answer: 1,
      explanation: "Reflecting in the x-axis keeps the x-coordinate the same but <strong>changes the sign of the y-coordinate</strong>. So (3, 5) becomes (3, −5). The point flips vertically over the x-axis."
    },
    {
      id: "c15_q28",
      topic: "Reflection of a point",
      type: "mcq",
      question: "Point P is at <strong>(−2, 4)</strong>. It is reflected in the <strong>x-axis</strong>. Where does P land?",
      options: ["(2, 4)", "(−2, −4)", "(2, −4)", "(4, −2)"],
      answer: 1,
      explanation: "Reflecting in the x-axis changes only the y-coordinate sign. The x-coordinate stays the same. So (−2, 4) becomes (−2, −4)."
    },
    {
      id: "c15_q29",
      topic: "Bearings",
      type: "mcq",
      question: "A ship travels on a bearing of <strong>270°</strong>. Which direction is it heading?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 220" aria-label="Compass showing bearing 270 is West">
  <rect width="220" height="220" fill="#f8fafc" rx="8"/>
  <circle cx="110" cy="110" r="85" fill="white" stroke="#e2e8f0" stroke-width="2"/>
  <!-- cardinal lines -->
  <line x1="110" y1="25" x2="110" y2="195" stroke="#e2e8f0" stroke-width="1"/>
  ...
  <line x1="110" y1="110" x2="110" y2="35" stroke="#64748b" stroke-width="2"/>
  <polygon points="110,28 105,40 115,40" fill="#64748b"/>
  <text x="110" y="20" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="13" font-weight="700">N (000°)</text>
  <!-- E label -->
  <text x="204" y="114" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="12">E (090°)</text>
  <!-- S label -->
  <text x="110" y="210" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="12">S (180°)</text>
  <!-- W arrow highlighted -->
  <line x1="110" y1="110" x2="35" y2="110" stroke="#f43f5e" stroke-width="3"/>
  <polygon points="28,110 40,104 40,116" fill="#f43f5e"/>
  <text x="12" y="107" text-anchor="middle" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">W</text>
  <text x="12" y="119" text-anchor="middle" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="11" font-weight="700">(270°)</text>
  <!-- arc from N clockwise to W showing 270° -->
  <path d="M 110 35 A 75 75 0 1 1 35 110" fill="none" stroke="#f59e0b" stroke-width="2" stroke-dasharray="5,3"/>
  <text x="155" y="165" fill="#f59e0b" font-family="Nunito,Arial,sans-serif" font-size="11" font-weight="700">270°</text>
</svg>`,
      options: ["North", "South", "East", "West"],
      answer: 3,
      explanation: "Bearings are measured clockwise from North. 000° = North, 090° = East, 180° = South, 270° = West. A bearing of 270° points due West."
    },
    {
      id: "c15_q30",
      topic: "Bearings",
      type: "mcq",
      question: "Which <strong>3-digit bearing</strong> represents due South?",
      options: ["090°", "270°", "180°", "360°"],
      answer: 2,
      explanation: "Bearings use 3-digit notation, measured clockwise from North. North = 000°, East = 090°, South = 180°, West = 270°. Due South is 180°."
    },
    {
      id: "c15_q31",
      topic: "Bearings",
      type: "input",
      question: "A lighthouse is on a bearing of <strong>135°</strong> from a boat. Which compass direction is nearest to this bearing? (Choose from: NE, SE, SW, NW)",
      answer: "SE",
      acceptableAnswers: ["SE", "South-East", "south-east"],
      explanation: "135° is clockwise from North. NE = 045°, SE = 135°, SW = 225°, NW = 315°. So 135° points exactly South-East (SE)."
    },
    {
      id: "c15_q32",
      topic: "Map scale",
  ...
  <text x="136" y="97" fill="#1e293b" font-family="Nunito,Arial,sans-serif" font-size="11">(2,3)</text>
    ...
    },
    {
      ...
      topic: "Midpoint of a line segment",
      type: "mcq",
      question: "The midpoint of <strong>AB</strong> is <strong>(3, −1)</strong>. Point A is at <strong>(1, 2)</strong>. What are the coordinates of point B?",
      options: ["(5, −4)", "(2, 0.5)", "(4, −2)", "(7, −3)"],
      answer: 0,
      explanation: "Using the midpoint formula: 3 = (1 + Bx)/2 → Bx = 6 − 1 = 5. And −1 = (2 + By)/2 → By = −2 − 2 = −4. So B = (5, −4). Always multiply the midpoint by 2 first, then subtract the known endpoint.",
      difficulty: "challenging"
    },
    {
      id: "c15_q39",
      topic: "Bearings",
      type: "mcq",
      question: "Point B is on a bearing of <strong>120°</strong> from point A. Which of these best describes the direction from A to B?",
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 220" aria-label="Compass showing bearing 120 degrees is between South and East, closer to SE">
  <rect width="220" height="220" fill="#f8fafc" rx="8"/>
  <circle cx="110" cy="110" r="85" fill="white" stroke="#e2e8f0" stroke-width="2"/>
  <!-- cardinal lines -->
  <line x1="110" y1="25" x2="110" y2="195" stroke="#e2e8f0" stroke-width="1"/>
  ...
  <line x1="110" y1="110" x2="110" y2="35" stroke="#64748b" stroke-width="2"/>
  <polygon points="110,28 105,40 115,40" fill="#64748b"/>
  <text x="110" y="20" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">N</text>
  <!-- E, SE, S labels -->
  <text x="202" y="114" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">E (090°)</text>
  <text x="181" y="184" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">SE</text>
  <text x="110" y="209" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">S (180°)</text>
  <text x="16" y="114" text-anchor="middle" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">W</text>
  <!-- bearing 120° arrow: 120° CW from N = 30° past E toward SE -->
  <!-- sin(120°)=0.866, cos(120°)=-0.5, so dx=+0.866, dy=+0.5 from N as up -->
  <!-- svgX = 110 + 75*sin(120°) = 110+65 = 175, svgY = 110 + 75*cos(120°-180°)... -->
  <!-- bearing angle: x=sin(120°)*75=64.95, y=cos(120°)*75=-37.5 → svgY=110-(-37.5)=147.5 wait -->
  <!-- bearing from north CW: svgX=cx+r*sin(θ), svgY=cy-r*cos(θ) -->
  <!-- θ=120°: sin=0.866, cos=-0.5 → svgX=110+75*0.866=175, svgY=110-75*(-0.5)=147.5 -->
  <line x1="110" y1="110" x2="175" y2="148" stroke="#f43f5e" stroke-width="3"/>
  <polygon points="179,151 167,143 173,133" fill="#f43f5e"/>
  <text x="178" y="160" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">120°</text>
  <!-- arc from N to 120° -->
  <path d="M 110 35 A 75 75 0 0 1 175 148" fill="none" stroke="#f59e0b" stroke-width="2" stroke-dasharray="5,3"/>
  <!-- centre dot -->
  <circle cx="110" cy="110" r="4" fill="#64748b"/>
  <text x="105" y="125" fill="#64748b" font-family="Nunito,Arial,sans-serif" font-size="11">A</text>
  <circle cx="175" cy="148" r="5" fill="#f43f5e"/>
  <text x="178" y="145" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="11">B</text>
</svg>`,
      options: ["North-East", "South-West", "South-East", "North-West"],
      answer: 2,
      explanation: "090° = East, 180° = South, so 120° falls between East and South — in the South-East direction, closer to East. The bearing 135° is exactly SE, and 120° is slightly north of SE but still in the south-east region.",
      difficulty: "challenging"
    },
    {
      id: "c15_q40",
  ...
  <text x="255" y="110" text-anchor="start" fill="#f43f5e" font-family="Nunito,Arial,sans-serif" font-size="12" font-weight="700">height = 3</text>
    ...
    },
    {
      ...
      topic: "Bearings",
      type: "mcq",
      question: "A boat sails from port on a bearing of <strong>060°</strong>. After some time it turns and sails on a bearing of <strong>240°</strong>. Which statement is true about the two bearings?",
      options: [
        "Both bearings point in the same direction",
        "240° is the back-bearing of 060° — they are exactly opposite directions",
        "240° is 60° more than 180°, so it points slightly west of south",
        "The boat is now heading North-East"
      ],
      answer: 1,
      explanation: "A bearing and its back-bearing (reverse direction) differ by exactly 180°. 060° + 180° = 240°. So 240° is exactly opposite to 060° — if you travelled on 060°, returning on 240° brings you back to the start.",
      difficulty: "challenging"
    }
  ]
};
